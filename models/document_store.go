...
var TableDocumentStore = "document_store"

// DocumentStore 文档存储，将大内容分发到专门的数据表里面
...
// GetFiledById 查询markdown内容或者content内容
...
// DeleteById 查询markdown内容或者content内容
...
// GetById 查询markdown内容或者content内容
