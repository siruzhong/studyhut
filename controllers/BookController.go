...
// IsPermission 判断是否具有管理员或管理员以上权限
...
// DownloadProject 从github等拉取下载markdown书籍
...
// replaceToAbs 查找并替换markdown文件中的路径，把图片链接替换成url的相对路径，把文档间的链接替换成【$+文档标识链接】
